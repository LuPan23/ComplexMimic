import complexmimic.learning.common_network_builder as common_network_builder
import torch
...
class AMPBuilder(common_network_builder.A2CBuilder):

    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        return

    class Network(common_network_builder.A2CBuilder.Network):
